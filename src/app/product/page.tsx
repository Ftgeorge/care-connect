      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
              <div className="flex-1">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2D3436] mb-2 lg:mb-4">
                  Symptom Checker
                </h1>
              ...
              <motion.button
                ...
                className="w-full sm:w-auto px-4 py-2.5 sm:px-6 sm:py-3 bg-gradient-to-r from-gray-100 to-gray-50 text-[#2D3436] rounded-xl hover:from-gray-200 hover:to-gray-100 transition-all duration-200 shadow-sm hover:shadow-md text-sm sm:text-base font-medium border border-gray-200/50"
              >
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-2xl lg:rounded-3xl shadow-xl border border-white/50 overflow-hidden"
          >
            <SymptomChat
              messages={messages}
