        ...
        >
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-4 grid grid-cols-2 sm:grid-cols-4 gap-6 lg:gap-8">
            ...
            <motion.div variants={itemVariants} className="col-span-1">
              <h3 className="font-bold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 lg:mb-6 text-gray-900">Company</h3>
            ...
            {/* Services Links */}
            <motion.div variants={itemVariants} className="col-span-1">
              <h3 className="font-bold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 lg:mb-6 text-gray-900">Services</h3>
              <ul className="space-y-2 sm:space-y-3">
            ...
            {/* Resources Links */}
            <motion.div variants={itemVariants} className="col-span-1">
              <h3 className="font-bold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 lg:mb-6 text-gray-900">Resources</h3>
              <ul className="space-y-2 sm:space-y-3">
            ...
            {/* Legal Links */}
            <motion.div variants={itemVariants} className="col-span-1">
              <h3 className="font-bold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 lg:mb-6 text-gray-900">Legal</h3>
              <ul className="space-y-2 sm:space-y-3">
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-10 lg:mb-12">
            {[
              ...
              >
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#D98586] mb-1 sm:mb-2">
                  {stat.number}
                </div>
